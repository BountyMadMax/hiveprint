...
export const config = $root.config = (() => {
    ...
    config.Config = (function() {
        ...
        Config.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.config.Config();
        ...
        Config.fromObject = function fromObject(object) {
            if (object instanceof $root.config.Config)
                return object;
            let message = new $root.config.Config();
            if (object.id != null)
    ...
    config.UserConfig = (function() {

        /**
         * Properties of a UserConfig.
         * @memberof config
         * @interface IUserConfig
         * @property {number|null} [id] UserConfig id
         * @property {string|null} [key] UserConfig key
         * @property {string|null} [value] UserConfig value
         * @property {auth.IUser|null} [user] UserConfig user
         */
         ...
         * @constructor
         * @param {config.IUserConfig=} [properties] Properties to set
         */
         ...
         * UserConfig id.
         * @member {number} id
         * @memberof config.UserConfig
         * @instance
         */
        UserConfig.prototype.id = 0;
         ...
         * @instance
         */
        UserConfig.prototype.user = null;
         ...
         * @static
         * @param {config.IUserConfig=} [properties] Properties to set
         * @returns {config.UserConfig} UserConfig instance
         */
        ...
        /**
         * Encodes the specified UserConfig message. Does not implicitly {@link config.UserConfig.verify|verify} messages.
         * @function encode
         * @memberof config.UserConfig
         * @static
         * @param {config.IUserConfig} message UserConfig message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        UserConfig.encode = function encode(message, writer) {
            ...
            if (message.user != null && Object.hasOwnProperty.call(message, "user"))
                $root.auth.User.encode(message.user, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified UserConfig message, length delimited. Does not implicitly {@link config.UserConfig.verify|verify} messages.
         * @function encodeDelimited
         * @memberof config.UserConfig
         * @static
         * @param {config.IUserConfig} message UserConfig message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {config.UserConfig} UserConfig
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        UserConfig.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.config.UserConfig();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        UserConfig.fromObject = function fromObject(object) {
            if (object instanceof $root.config.UserConfig)
                return object;
            let message = new $root.config.UserConfig();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.key != null)
                message.key = String(object.key);
            ...
            if (object.user != null) {
                if (typeof object.user !== "object")
                    throw TypeError(".config.UserConfig.user: object expected");
         ...
         * @memberof config.UserConfig
         * @static
         * @param {config.UserConfig} message UserConfig
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Gets the default type url for UserConfig
         * @function getTypeUrl
         * @memberof config.UserConfig
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        UserConfig.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/config.UserConfig";
        };
...
export const auth = $root.auth = (() => {
    ...
    auth.User = (function() {
         ...
         * @property {Array.<auth.IRole>|null} [roles] User roles
         */
        ...
        User.encode = function encode(message, writer) {
            ...
            if (message.roles != null && message.roles.length)
                for (let i = 0; i < message.roles.length; ++i)
                    $root.auth.Role.encode(message.roles[i], writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
            return writer;
        };
            ...
            while (reader.pos < end) {
                ...
                case 7: {
                        if (!(message.roles && message.roles.length))
                            message.roles = [];
                        message.roles.push($root.auth.Role.decode(reader, reader.uint32()));
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        User.verify = function verify(message) {
            ...
            if (message.roles != null && message.hasOwnProperty("roles")) {
                ...
                for (let i = 0; i < message.roles.length; ++i) {
                    let error = $root.auth.Role.verify(message.roles[i]);
                    if (error)
                        return "roles." + error;
                }
            }
        ...
        User.fromObject = function fromObject(object) {
            ...
            if (object.roles) {
                if (!Array.isArray(object.roles))
                    throw TypeError(".auth.User.roles: array expected");
                message.roles = [];
                for (let i = 0; i < object.roles.length; ++i) {
                    if (typeof object.roles[i] !== "object")
                        throw TypeError(".auth.User.roles: object expected");
                    message.roles[i] = $root.auth.Role.fromObject(object.roles[i]);
                }
            }
            return message;
        };
        ...
        User.toObject = function toObject(message, options) {
            ...
            if (message.roles && message.roles.length) {
                ...
                for (let j = 0; j < message.roles.length; ++j)
                    object.roles[j] = $root.auth.Role.toObject(message.roles[j], options);
            }
            return object;
        };
    ...
    auth.Role = (function() {
         ...
         * @property {Array.<auth.IPermission>|null} [permissions] Role permissions
         */
         ...
         * @implements IRole
         * @constructor
         * @param {auth.IRole=} [properties] Properties to set
         */
        ...
        /**
         * Role permissions.
         * @member {Array.<auth.IPermission>} permissions
         * @memberof auth.Role
         * @instance
         */
         ...
         * @static
         * @param {auth.IRole=} [properties] Properties to set
         * @returns {auth.Role} Role instance
         */
        ...
        /**
         * Encodes the specified Role message. Does not implicitly {@link auth.Role.verify|verify} messages.
         * @function encode
         * @memberof auth.Role
         * @static
         * @param {auth.IRole} message Role message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Role.encode = function encode(message, writer) {
            ...
            if (message.permissions != null && message.permissions.length)
                for (let i = 0; i < message.permissions.length; ++i)
                    $root.auth.Permission.encode(message.permissions[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified Role message, length delimited. Does not implicitly {@link auth.Role.verify|verify} messages.
         * @function encodeDelimited
         * @memberof auth.Role
         * @static
         * @param {auth.IRole} message Role message or plain object to encode
        ...
        Role.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.auth.Role();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Role.verify = function verify(message) {
            ...
            if (message.permissions != null && message.hasOwnProperty("permissions")) {
                ...
                for (let i = 0; i < message.permissions.length; ++i) {
                    let error = $root.auth.Permission.verify(message.permissions[i]);
                    if (error)
        ...
        Role.fromObject = function fromObject(object) {
            if (object instanceof $root.auth.Role)
                return object;
            let message = new $root.auth.Role();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.name != null)
                message.name = String(object.name);
            if (object.permissions) {
                if (!Array.isArray(object.permissions))
                    throw TypeError(".auth.Role.permissions: array expected");
                message.permissions = [];
                for (let i = 0; i < object.permissions.length; ++i) {
                    if (typeof object.permissions[i] !== "object")
                        throw TypeError(".auth.Role.permissions: object expected");
                    message.permissions[i] = $root.auth.Permission.fromObject(object.permissions[i]);
                }
            }
            return message;
        };
        ...
        Role.toObject = function toObject(message, options) {
            ...
            if (message.permissions && message.permissions.length) {
                ...
                for (let j = 0; j < message.permissions.length; ++j)
                    object.permissions[j] = $root.auth.Permission.toObject(message.permissions[j], options);
            }
            return object;
        };
        ...
        Role.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/auth.Role";
        };
    ...
    auth.Permission = (function() {
         ...
         * @property {string|null} [key] Permission key
         */
         ...
         * @static
         * @param {auth.IPermission=} [properties] Properties to set
         * @returns {auth.Permission} Permission instance
         */
         ...
         * @memberof auth.Permission
         * @static
         * @param {auth.IPermission} message Permission message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified Permission message, length delimited. Does not implicitly {@link auth.Permission.verify|verify} messages.
         * @function encodeDelimited
         * @memberof auth.Permission
         * @static
         * @param {auth.IPermission} message Permission message or plain object to encode
        ...
        Permission.fromObject = function fromObject(object) {
            if (object instanceof $root.auth.Permission)
                return object;
            let message = new $root.auth.Permission();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.key != null)
                message.key = String(object.key);
         ...
         * @memberof auth.Permission
         * @static
         * @param {auth.Permission} message Permission
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
