...
export const creator = $root.creator = (() => {
    ...
    creator.Creator = (function() {
         ...
         * @property {Array.<creator.ICreatorLink>|null} [links] Creator links
         * @property {Array.<tag.ITag>|null} [tags] Creator tags
         */
         ...
         * @implements ICreator
         * @constructor
         * @param {creator.ICreator=} [properties] Properties to set
         */
        ...
        /**
         * Creator links.
         * @member {Array.<creator.ICreatorLink>} links
         * @memberof creator.Creator
         * @instance
         */
         ...
         * @instance
         */
        Creator.prototype.tags = $util.emptyArray;
         ...
         * @static
         * @param {creator.ICreator=} [properties] Properties to set
         * @returns {creator.Creator} Creator instance
         */
        ...
        /**
         * Encodes the specified Creator message. Does not implicitly {@link creator.Creator.verify|verify} messages.
         * @function encode
         * @memberof creator.Creator
         * @static
         * @param {creator.ICreator} message Creator message or plain object to encode
        ...
        Creator.encode = function encode(message, writer) {
            ...
            if (message.links != null && message.links.length)
                for (let i = 0; i < message.links.length; ++i)
                    $root.creator.CreatorLink.encode(message.links[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.tags != null && message.tags.length)
                for (let i = 0; i < message.tags.length; ++i)
                    $root.tag.Tag.encode(message.tags[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified Creator message, length delimited. Does not implicitly {@link creator.Creator.verify|verify} messages.
         ...
         * @returns {creator.Creator} Creator
        ...
        Creator.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.creator.Creator();
            while (reader.pos < end) {
                ...
                case 4: {
                        if (!(message.links && message.links.length))
                            message.links = [];
                        message.links.push($root.creator.CreatorLink.decode(reader, reader.uint32()));
                        break;
                    }
                case 5: {
        ...
        Creator.verify = function verify(message) {
            ...
            if (message.links != null && message.hasOwnProperty("links")) {
                ...
                for (let i = 0; i < message.links.length; ++i) {
                    let error = $root.creator.CreatorLink.verify(message.links[i]);
                    if (error)
                        return "links." + error;
                }
            }
        ...
        Creator.fromObject = function fromObject(object) {
            if (object instanceof $root.creator.Creator)
                return object;
            let message = new $root.creator.Creator();
            if (object.id != null)
            ...
            if (object.links) {
                if (!Array.isArray(object.links))
                    throw TypeError(".creator.Creator.links: array expected");
                message.links = [];
                for (let i = 0; i < object.links.length; ++i) {
                    if (typeof object.links[i] !== "object")
                        throw TypeError(".creator.Creator.links: object expected");
                    message.links[i] = $root.creator.CreatorLink.fromObject(object.links[i]);
                }
            }
            if (object.tags) {
                if (!Array.isArray(object.tags))
                    throw TypeError(".creator.Creator.tags: array expected");
                message.tags = [];
                for (let i = 0; i < object.tags.length; ++i) {
                    if (typeof object.tags[i] !== "object")
                        throw TypeError(".creator.Creator.tags: object expected");
         ...
         * @memberof creator.Creator
         * @static
         * @param {creator.Creator} message Creator
        ...
        Creator.toObject = function toObject(message, options) {
            ...
            if (message.links && message.links.length) {
                ...
                for (let j = 0; j < message.links.length; ++j)
                    object.links[j] = $root.creator.CreatorLink.toObject(message.links[j], options);
            }
            if (message.tags && message.tags.length) {
                object.tags = [];
        ...
        Creator.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/creator.Creator";
        };

        return Creator;
    })();

    creator.CreatorLink = (function() {
         ...
         * @property {creator.CreatorLinkType|null} [type] CreatorLink type
         */
         ...
         * @constructor
         * @param {creator.ICreatorLink=} [properties] Properties to set
         */
        ...
        /**
         * CreatorLink type.
         * @member {creator.CreatorLinkType} type
         * @memberof creator.CreatorLink
         * @instance
         */
         ...
         * @static
         * @param {creator.ICreatorLink=} [properties] Properties to set
         * @returns {creator.CreatorLink} CreatorLink instance
         */
        ...
        /**
         * Encodes the specified CreatorLink message. Does not implicitly {@link creator.CreatorLink.verify|verify} messages.
         * @function encode
         * @memberof creator.CreatorLink
         * @static
         * @param {creator.ICreatorLink} message CreatorLink message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified CreatorLink message, length delimited. Does not implicitly {@link creator.CreatorLink.verify|verify} messages.
         * @function encodeDelimited
         * @memberof creator.CreatorLink
         * @static
         * @param {creator.ICreatorLink} message CreatorLink message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {creator.CreatorLink} CreatorLink
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CreatorLink.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.creator.CreatorLink();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        CreatorLink.fromObject = function fromObject(object) {
            if (object instanceof $root.creator.CreatorLink)
                return object;
            let message = new $root.creator.CreatorLink();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.link != null)
         ...
         * @memberof creator.CreatorLink
         * @static
         * @param {creator.CreatorLink} message CreatorLink
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CreatorLink.toObject = function toObject(message, options) {
            ...
            if (message.type != null && message.hasOwnProperty("type"))
                object.type = options.enums === String ? $root.creator.CreatorLinkType[message.type] === undefined ? message.type : $root.creator.CreatorLinkType[message.type] : message.type;
            return object;
        };
        ...
        CreatorLink.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/creator.CreatorLink";
        };
     ...
     * @property {number} TWITTER=6 TWITTER value
     * @property {number} DISCORD=7 DISCORD value
     * @property {number} KICKSTARTER=8 KICKSTARTER value
     * @property {number} TIKTOK=9 TIKTOK value
     * @property {number} THINGIVERSE=10 THINGIVERSE value
     * @property {number} CGTRADER=11 CGTRADER value
     * @property {number} CULTS3D=12 CULTS3D value
     * @property {number} MYMINIFACTORY=13 MYMINIFACTORY value
     * @property {number} PRINTABLES=14 PRINTABLES value
     * @property {number} PRINTED_WARGAMES=15 PRINTED_WARGAMES value
     * @property {number} ETSY=16 ETSY value
     */
    creator.CreatorLinkType = (function() {
        ...
        values[valuesById[8] = "KICKSTARTER"] = 8;
        values[valuesById[9] = "TIKTOK"] = 9;
        values[valuesById[10] = "THINGIVERSE"] = 10;
        values[valuesById[11] = "CGTRADER"] = 11;
        values[valuesById[12] = "CULTS3D"] = 12;
        values[valuesById[13] = "MYMINIFACTORY"] = 13;
        values[valuesById[14] = "PRINTABLES"] = 14;
        values[valuesById[15] = "PRINTED_WARGAMES"] = 15;
        values[valuesById[16] = "ETSY"] = 16;
        return values;
    })();
