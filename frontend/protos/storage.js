...
export const storage = $root.storage = (() => {
    ...
    storage.Storage = (function() {
         ...
         * @property {storage.StorageProtocol|null} [protocol] Storage protocol
         * @property {storage.IStorageCredentials|null} [credentials] Storage credentials
         * @property {string|null} [location] Storage location
         * @property {storage.StorageLocationType|null} [locationType] Storage locationType
         * @property {Array.<tag.ITag>|null} [tags] Storage tags
         */
        ...
        /**
         * Storage protocol.
         * @member {storage.StorageProtocol} protocol
         * @memberof storage.Storage
         * @instance
         */
        ...
        /**
         * Storage credentials.
         * @member {storage.IStorageCredentials|null|undefined} credentials
         * @memberof storage.Storage
         * @instance
         */
         ...
         * @instance
         */
        Storage.prototype.location = "";

        /**
         * Storage locationType.
         * @member {storage.StorageLocationType} locationType
         * @memberof storage.Storage
         * @instance
         */
        Storage.prototype.locationType = 0;
         ...
         * @instance
         */
        Storage.prototype.tags = $util.emptyArray;
        ...
        Storage.encode = function encode(message, writer) {
            ...
            if (message.credentials != null && Object.hasOwnProperty.call(message, "credentials"))
                $root.storage.StorageCredentials.encode(message.credentials, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            ...
            if (message.locationType != null && Object.hasOwnProperty.call(message, "locationType"))
                writer.uint32(/* id 7, wireType 0 =*/56).int32(message.locationType);
            if (message.tags != null && message.tags.length)
                for (let i = 0; i < message.tags.length; ++i)
                    $root.tag.Tag.encode(message.tags[i], writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
            return writer;
        };
        ...
        Storage.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 5: {
                        message.credentials = $root.storage.StorageCredentials.decode(reader, reader.uint32());
                        break;
                    }
                case 6: {
        ...
        Storage.verify = function verify(message) {
            ...
            if (message.credentials != null && message.hasOwnProperty("credentials")) {
                let error = $root.storage.StorageCredentials.verify(message.credentials);
                if (error)
        ...
        Storage.fromObject = function fromObject(object) {
            ...
            if (object.credentials != null) {
                if (typeof object.credentials !== "object")
                    throw TypeError(".storage.Storage.credentials: object expected");
                message.credentials = $root.storage.StorageCredentials.fromObject(object.credentials);
            }
            ...
            if (object.tags) {
                if (!Array.isArray(object.tags))
                    throw TypeError(".storage.Storage.tags: array expected");
                message.tags = [];
                for (let i = 0; i < object.tags.length; ++i) {
                    if (typeof object.tags[i] !== "object")
                        throw TypeError(".storage.Storage.tags: object expected");
        ...
        Storage.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.location = "";
                object.locationType = options.enums === String ? "FILE_PATH" : 0;
            }
            if (message.id != null && message.hasOwnProperty("id"))
            ...
            if (message.protocol != null && message.hasOwnProperty("protocol"))
                object.protocol = options.enums === String ? $root.storage.StorageProtocol[message.protocol] === undefined ? message.protocol : $root.storage.StorageProtocol[message.protocol] : message.protocol;
            if (message.credentials != null && message.hasOwnProperty("credentials"))
                object.credentials = $root.storage.StorageCredentials.toObject(message.credentials, options);
            if (message.location != null && message.hasOwnProperty("location"))
                object.location = message.location;
            if (message.locationType != null && message.hasOwnProperty("locationType"))
                object.locationType = options.enums === String ? $root.storage.StorageLocationType[message.locationType] === undefined ? message.locationType : $root.storage.StorageLocationType[message.locationType] : message.locationType;
            if (message.tags && message.tags.length) {
                object.tags = [];
     ...
     * @property {number} SFTP=5 SFTP value
     */
    storage.StorageProtocol = (function() {
        ...
        values[valuesById[5] = "SFTP"] = 5;
        return values;
    })();

    storage.StorageCredentials = (function() {
         ...
         * @property {string|null} [username] StorageCredentials username
         ...
         * @constructor
         * @param {storage.IStorageCredentials=} [properties] Properties to set
         */
         ...
         * @member {number} id
         * @memberof storage.StorageCredentials
         * @instance
         */
        StorageCredentials.prototype.id = 0;

        /**
         * StorageCredentials username.
         * @member {string} username
         * @memberof storage.StorageCredentials
         * @instance
         */
        StorageCredentials.prototype.username = "";
         ...
         * @instance
         */
        StorageCredentials.prototype.password = "";
         ...
         * @static
         * @param {storage.IStorageCredentials=} [properties] Properties to set
         * @returns {storage.StorageCredentials} StorageCredentials instance
         */
        ...
        /**
         * Encodes the specified StorageCredentials message. Does not implicitly {@link storage.StorageCredentials.verify|verify} messages.
         * @function encode
         * @memberof storage.StorageCredentials
         * @static
         * @param {storage.IStorageCredentials} message StorageCredentials message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified StorageCredentials message, length delimited. Does not implicitly {@link storage.StorageCredentials.verify|verify} messages.
         * @function encodeDelimited
         * @memberof storage.StorageCredentials
         * @static
         * @param {storage.IStorageCredentials} message StorageCredentials message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {storage.StorageCredentials} StorageCredentials
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        StorageCredentials.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.storage.StorageCredentials();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        StorageCredentials.fromObject = function fromObject(object) {
            if (object instanceof $root.storage.StorageCredentials)
                return object;
            let message = new $root.storage.StorageCredentials();
            if (object.id != null)
                message.id = object.id | 0;
         ...
         * @memberof storage.StorageCredentials
         * @static
         * @param {storage.StorageCredentials} message StorageCredentials
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        StorageCredentials.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/storage.StorageCredentials";
        };
     ...
     * @name storage.StorageLocationType
     * @enum {number}
     * @property {number} FILE_PATH=0 FILE_PATH value
     * @property {number} HOSTNAME=1 HOSTNAME value
     * @property {number} IP=2 IP value
     */
    storage.StorageLocationType = (function() {
        const valuesById = {}, values = Object.create(valuesById);
        values[valuesById[0] = "FILE_PATH"] = 0;
        values[valuesById[1] = "HOSTNAME"] = 1;
