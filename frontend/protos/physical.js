...
export const physical = $root.physical = (() => {
    ...
    physical.Room = (function() {
         ...
         * @property {physical.IBuilding|null} [building] Room building
         * @property {Array.<tag.ITag>|null} [tags] Room tags
         */
         ...
         * @implements IRoom
         * @constructor
         * @param {physical.IRoom=} [properties] Properties to set
         */
         ...
         * @instance
         */
        Room.prototype.description = null;

        /**
         * Room building.
         * @member {physical.IBuilding|null|undefined} building
         * @memberof physical.Room
         * @instance
         */
        Room.prototype.building = null;
         ...
         * @instance
         */
        Object.defineProperty(Room.prototype, "_description", {
         ...
         * @static
         * @param {physical.IRoom=} [properties] Properties to set
         * @returns {physical.Room} Room instance
         */
        ...
        /**
         * Encodes the specified Room message. Does not implicitly {@link physical.Room.verify|verify} messages.
         * @function encode
         * @memberof physical.Room
         * @static
         * @param {physical.IRoom} message Room message or plain object to encode
        ...
        Room.encode = function encode(message, writer) {
            ...
            if (message.building != null && Object.hasOwnProperty.call(message, "building"))
                $root.physical.Building.encode(message.building, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
        ...
        /**
         * Encodes the specified Room message, length delimited. Does not implicitly {@link physical.Room.verify|verify} messages.
        ...
        Room.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.physical.Room();
            while (reader.pos < end) {
                ...
                case 4: {
                        message.building = $root.physical.Building.decode(reader, reader.uint32());
                        break;
                    }
                case 5: {
        ...
        Room.verify = function verify(message) {
            ...
            if (message.building != null && message.hasOwnProperty("building")) {
                let error = $root.physical.Building.verify(message.building);
                if (error)
        ...
        Room.fromObject = function fromObject(object) {
            if (object instanceof $root.physical.Room)
                return object;
            let message = new $root.physical.Room();
            if (object.id != null)
            ...
            if (object.building != null) {
                if (typeof object.building !== "object")
                    throw TypeError(".physical.Room.building: object expected");
                message.building = $root.physical.Building.fromObject(object.building);
            }
            if (object.tags) {
                if (!Array.isArray(object.tags))
                    throw TypeError(".physical.Room.tags: array expected");
                message.tags = [];
                for (let i = 0; i < object.tags.length; ++i) {
                    if (typeof object.tags[i] !== "object")
                        throw TypeError(".physical.Room.tags: object expected");
         ...
         * @memberof physical.Room
         * @static
         * @param {physical.Room} message Room
        ...
        Room.toObject = function toObject(message, options) {
            ...
            if (message.building != null && message.hasOwnProperty("building"))
                object.building = $root.physical.Building.toObject(message.building, options);
            if (message.tags && message.tags.length) {
                object.tags = [];
        ...
        Room.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/physical.Room";
        };

        return Room;
    })();

    physical.Building = (function() {
         ...
         * @property {string|null} [description] Building description
         * @property {Array.<tag.ITag>|null} [tags] Building tags
         */
         ...
         * @constructor
         * @param {physical.IBuilding=} [properties] Properties to set
         */
         ...
         * @instance
         */
        Building.prototype.description = null;
         ...
         * @instance
         */
        Building.prototype.tags = $util.emptyArray;
         ...
         * @instance
         */
        Object.defineProperty(Building.prototype, "_description", {
            get: $util.oneOfGetter($oneOfFields = ["description"]),
            set: $util.oneOfSetter($oneOfFields)
        });
         ...
         * @static
         * @param {physical.IBuilding=} [properties] Properties to set
         * @returns {physical.Building} Building instance
         */
        ...
        /**
         * Encodes the specified Building message. Does not implicitly {@link physical.Building.verify|verify} messages.
         * @function encode
         * @memberof physical.Building
         * @static
         * @param {physical.IBuilding} message Building message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified Building message, length delimited. Does not implicitly {@link physical.Building.verify|verify} messages.
         * @function encodeDelimited
         * @memberof physical.Building
         * @static
         * @param {physical.IBuilding} message Building message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {physical.Building} Building
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Building.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.physical.Building();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Building.fromObject = function fromObject(object) {
            if (object instanceof $root.physical.Building)
                return object;
            let message = new $root.physical.Building();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.name != null)
                message.name = String(object.name);
            ...
            if (object.tags) {
                if (!Array.isArray(object.tags))
                    throw TypeError(".physical.Building.tags: array expected");
                message.tags = [];
                for (let i = 0; i < object.tags.length; ++i) {
                    if (typeof object.tags[i] !== "object")
                        throw TypeError(".physical.Building.tags: object expected");
                    message.tags[i] = $root.tag.Tag.fromObject(object.tags[i]);
                }
            }
            return message;
         ...
         * @memberof physical.Building
         * @static
         * @param {physical.Building} message Building
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        Building.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/physical.Building";
        };
