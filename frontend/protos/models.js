...
export const models = $root.models = (() => {
    ...
    models.Model = (function() {
         ...
         * @memberof models
         * @interface IModel
         * @property {number|null} [id] Model id
         * @property {string|null} [name] Model name
         * @property {string|null} [description] Model description
         * @property {Array.<models.IModelPart>|null} [modelParts] Model modelParts
         * @property {Array.<models.ICreator>|null} [creators] Model creators
         */
         ...
         * @implements IModel
         * @constructor
         * @param {models.IModel=} [properties] Properties to set
         */
        ...
        /**
         * Model modelParts.
         * @member {Array.<models.IModelPart>} modelParts
         * @memberof models.Model
         * @instance
         */
        Model.prototype.modelParts = $util.emptyArray;

        /**
         * Model creators.
         * @member {Array.<models.ICreator>} creators
         * @memberof models.Model
         * @instance
         */
        Model.prototype.creators = $util.emptyArray;
         ...
         * @instance
         */
        Object.defineProperty(Model.prototype, "_description", {
         ...
         * @static
         * @param {models.IModel=} [properties] Properties to set
         * @returns {models.Model} Model instance
         */
        ...
        /**
         * Encodes the specified Model message. Does not implicitly {@link models.Model.verify|verify} messages.
         * @function encode
         * @memberof models.Model
         * @static
         * @param {models.IModel} message Model message or plain object to encode
        ...
        Model.encode = function encode(message, writer) {
            ...
            if (message.modelParts != null && message.modelParts.length)
                for (let i = 0; i < message.modelParts.length; ++i)
                    $root.models.ModelPart.encode(message.modelParts[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.creators != null && message.creators.length)
                for (let i = 0; i < message.creators.length; ++i)
                    $root.models.Creator.encode(message.creators[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified Model message, length delimited. Does not implicitly {@link models.Model.verify|verify} messages.
        ...
        Model.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.models.Model();
            while (reader.pos < end) {
                ...
                case 4: {
                        if (!(message.modelParts && message.modelParts.length))
                            message.modelParts = [];
                        message.modelParts.push($root.models.ModelPart.decode(reader, reader.uint32()));
                        break;
                    }
                case 5: {
                        if (!(message.creators && message.creators.length))
                            message.creators = [];
                        message.creators.push($root.models.Creator.decode(reader, reader.uint32()));
                        break;
                    }
                default:
        ...
        Model.verify = function verify(message) {
            ...
            if (message.modelParts != null && message.hasOwnProperty("modelParts")) {
                if (!Array.isArray(message.modelParts))
                    return "modelParts: array expected";
                for (let i = 0; i < message.modelParts.length; ++i) {
                    let error = $root.models.ModelPart.verify(message.modelParts[i]);
                    if (error)
                        return "modelParts." + error;
                }
            }
            if (message.creators != null && message.hasOwnProperty("creators")) {
                if (!Array.isArray(message.creators))
                    return "creators: array expected";
                for (let i = 0; i < message.creators.length; ++i) {
                    let error = $root.models.Creator.verify(message.creators[i]);
                    if (error)
        ...
        Model.fromObject = function fromObject(object) {
            if (object instanceof $root.models.Model)
                return object;
            let message = new $root.models.Model();
            if (object.id != null)
            ...
            if (object.modelParts) {
                if (!Array.isArray(object.modelParts))
                    throw TypeError(".models.Model.modelParts: array expected");
                message.modelParts = [];
                for (let i = 0; i < object.modelParts.length; ++i) {
                    if (typeof object.modelParts[i] !== "object")
                        throw TypeError(".models.Model.modelParts: object expected");
                    message.modelParts[i] = $root.models.ModelPart.fromObject(object.modelParts[i]);
                }
            }
            if (object.creators) {
                if (!Array.isArray(object.creators))
                    throw TypeError(".models.Model.creators: array expected");
                message.creators = [];
                for (let i = 0; i < object.creators.length; ++i) {
                    if (typeof object.creators[i] !== "object")
                        throw TypeError(".models.Model.creators: object expected");
                    message.creators[i] = $root.models.Creator.fromObject(object.creators[i]);
                }
            }
            return message;
        };
         ...
         * @memberof models.Model
         * @static
         * @param {models.Model} message Model
        ...
        Model.toObject = function toObject(message, options) {
            ...
            if (message.modelParts && message.modelParts.length) {
                object.modelParts = [];
                for (let j = 0; j < message.modelParts.length; ++j)
                    object.modelParts[j] = $root.models.ModelPart.toObject(message.modelParts[j], options);
            }
            if (message.creators && message.creators.length) {
                object.creators = [];
                for (let j = 0; j < message.creators.length; ++j)
                    object.creators[j] = $root.models.Creator.toObject(message.creators[j], options);
            }
            return object;
        };
        ...
        Model.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/models.Model";
        };

        return Model;
    })();

    models.ModelPart = (function() {

        /**
         * Properties of a ModelPart.
         * @memberof models
         * @interface IModelPart
         * @property {number|null} [id] ModelPart id
         * @property {string|null} [name] ModelPart name
         * @property {string|null} [description] ModelPart description
         * @property {Array.<models.IModel>|null} [models] ModelPart models
         * @property {Array.<models.ICreator>|null} [creators] ModelPart creators
         */

        /**
         * Constructs a new ModelPart.
         * @memberof models
         * @classdesc Represents a ModelPart.
         * @implements IModelPart
         * @constructor
         * @param {models.IModelPart=} [properties] Properties to set
         */
        function ModelPart(properties) {
            this.models = [];
            this.creators = [];
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
         ...
         * ModelPart id.
         * @member {number} id
         * @memberof models.ModelPart
         * @instance
         */
        ModelPart.prototype.id = 0;
         ...
         * @instance
         */
        ModelPart.prototype.description = null;

        /**
         * ModelPart models.
         * @member {Array.<models.IModel>} models
         * @memberof models.ModelPart
         * @instance
         */
        ModelPart.prototype.models = $util.emptyArray;
         ...
         * @instance
         */
        ModelPart.prototype.creators = $util.emptyArray;

        // OneOf field names bound to virtual getters and setters
        let $oneOfFields;

        /**
         * ModelPart _description.
         * @member {"description"|undefined} _description
         * @memberof models.ModelPart
         * @instance
         */
        Object.defineProperty(ModelPart.prototype, "_description", {
            get: $util.oneOfGetter($oneOfFields = ["description"]),
            set: $util.oneOfSetter($oneOfFields)
        });

        /**
         * Creates a new ModelPart instance using the specified properties.
         * @function create
         * @memberof models.ModelPart
         * @static
         * @param {models.IModelPart=} [properties] Properties to set
         * @returns {models.ModelPart} ModelPart instance
         */
        ModelPart.create = function create(properties) {
            return new ModelPart(properties);
        };

        /**
         * Encodes the specified ModelPart message. Does not implicitly {@link models.ModelPart.verify|verify} messages.
         * @function encode
         * @memberof models.ModelPart
         * @static
         * @param {models.IModelPart} message ModelPart message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ModelPart.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.id != null && Object.hasOwnProperty.call(message, "id"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.id);
            ...
            if (message.models != null && message.models.length)
                for (let i = 0; i < message.models.length; ++i)
                    $root.models.Model.encode(message.models[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.creators != null && message.creators.length)
                for (let i = 0; i < message.creators.length; ++i)
                    $root.models.Creator.encode(message.creators[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            return writer;
        ...
        /**
         * Encodes the specified ModelPart message, length delimited. Does not implicitly {@link models.ModelPart.verify|verify} messages.
         * @function encodeDelimited
         * @memberof models.ModelPart
         * @static
         * @param {models.IModelPart} message ModelPart message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ModelPart.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a ModelPart message from the specified reader or buffer.
         * @function decode
         * @memberof models.ModelPart
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {models.ModelPart} ModelPart
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ModelPart.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.models.ModelPart();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
                ...
                case 4: {
                        if (!(message.models && message.models.length))
                            message.models = [];
                        message.models.push($root.models.Model.decode(reader, reader.uint32()));
                        break;
                    }
                case 5: {
                        if (!(message.creators && message.creators.length))
        ...
        /**
         * Decodes a ModelPart message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof models.ModelPart
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ModelPart.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ModelPart.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            let properties = {};
            if (message.id != null && message.hasOwnProperty("id"))
            ...
            if (message.models != null && message.hasOwnProperty("models")) {
                ...
                for (let i = 0; i < message.models.length; ++i) {
                    let error = $root.models.Model.verify(message.models[i]);
                    if (error)
                        return "models." + error;
                }
            }
        ...
        /**
         * Creates a ModelPart message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof models.ModelPart
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {models.ModelPart} ModelPart
         */
        ModelPart.fromObject = function fromObject(object) {
            if (object instanceof $root.models.ModelPart)
                return object;
            let message = new $root.models.ModelPart();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.name != null)
                message.name = String(object.name);
            ...
            if (object.models) {
                if (!Array.isArray(object.models))
                    throw TypeError(".models.ModelPart.models: array expected");
                message.models = [];
                for (let i = 0; i < object.models.length; ++i) {
                    if (typeof object.models[i] !== "object")
                        throw TypeError(".models.ModelPart.models: object expected");
                    message.models[i] = $root.models.Model.fromObject(object.models[i]);
                }
            }
            if (object.creators) {
                if (!Array.isArray(object.creators))
                    throw TypeError(".models.ModelPart.creators: array expected");
                message.creators = [];
                for (let i = 0; i < object.creators.length; ++i) {
                    if (typeof object.creators[i] !== "object")
                        throw TypeError(".models.ModelPart.creators: object expected");
                    message.creators[i] = $root.models.Creator.fromObject(object.creators[i]);
                }
            }
            return message;
        ...
        /**
         * Creates a plain object from a ModelPart message. Also converts values to other types if specified.
         * @function toObject
         * @memberof models.ModelPart
         * @static
         * @param {models.ModelPart} message ModelPart
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ModelPart.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.arrays || options.defaults) {
            ...
            if (message.models && message.models.length) {
                ...
                for (let j = 0; j < message.models.length; ++j)
                    object.models[j] = $root.models.Model.toObject(message.models[j], options);
            }
            if (message.creators && message.creators.length) {
                object.creators = [];
                for (let j = 0; j < message.creators.length; ++j)
        ...
        /**
         * Converts this ModelPart to JSON.
         * @function toJSON
         * @memberof models.ModelPart
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ModelPart.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for ModelPart
         * @function getTypeUrl
         * @memberof models.ModelPart
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        ModelPart.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/models.ModelPart";
        };

        ModelPart.Storage = (function() {

            /**
             * Properties of a Storage.
             * @memberof models.ModelPart
             * @interface IStorage
             * @property {string|null} [fileName] Storage fileName
             * @property {string|null} [path] Storage path
             * @property {models.ModelPart.IStorage|null} [storage] Storage storage
             */
             ...
             * @implements IStorage
             * @constructor
             * @param {models.ModelPart.IStorage=} [properties] Properties to set
             */
             ...
             * @memberof models.ModelPart.Storage
             * @instance
             */
            Storage.prototype.fileName = "";
             ...
             * @instance
             */
            Storage.prototype.path = "";

            /**
             * Storage storage.
             * @member {models.ModelPart.IStorage|null|undefined} storage
             * @memberof models.ModelPart.Storage
             * @instance
             */
             ...
             * @static
             * @param {models.ModelPart.IStorage=} [properties] Properties to set
             * @returns {models.ModelPart.Storage} Storage instance
             */
            ...
            /**
             * Encodes the specified Storage message. Does not implicitly {@link models.ModelPart.Storage.verify|verify} messages.
             * @function encode
             * @memberof models.ModelPart.Storage
             * @static
             * @param {models.ModelPart.IStorage} message Storage message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            Storage.encode = function encode(message, writer) {
                ...
                if (message.storage != null && Object.hasOwnProperty.call(message, "storage"))
                    $root.models.ModelPart.Storage.encode(message.storage, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                return writer;
            };

            /**
             * Encodes the specified Storage message, length delimited. Does not implicitly {@link models.ModelPart.Storage.verify|verify} messages.
             * @function encodeDelimited
             * @memberof models.ModelPart.Storage
             * @static
             * @param {models.ModelPart.IStorage} message Storage message or plain object to encode
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {models.ModelPart.Storage} Storage
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            Storage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.models.ModelPart.Storage();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                    ...
                    case 3: {
                            message.storage = $root.models.ModelPart.Storage.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            Storage.verify = function verify(message) {
                ...
                if (message.storage != null && message.hasOwnProperty("storage")) {
                    let error = $root.models.ModelPart.Storage.verify(message.storage);
                    if (error)
            ...
            Storage.fromObject = function fromObject(object) {
                if (object instanceof $root.models.ModelPart.Storage)
                    return object;
                let message = new $root.models.ModelPart.Storage();
                ...
                if (object.storage != null) {
                    if (typeof object.storage !== "object")
                        throw TypeError(".models.ModelPart.Storage.storage: object expected");
                    message.storage = $root.models.ModelPart.Storage.fromObject(object.storage);
                }
                return message;
            };
             ...
             * @memberof models.ModelPart.Storage
             * @static
             * @param {models.ModelPart.Storage} message Storage
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            Storage.toObject = function toObject(message, options) {
                ...
                if (message.storage != null && message.hasOwnProperty("storage"))
                    object.storage = $root.models.ModelPart.Storage.toObject(message.storage, options);
                return object;
            };
            ...
            Storage.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/models.ModelPart.Storage";
            };
    ...
    models.Creator = (function() {

        /**
         * Properties of a Creator.
         * @memberof models
         * @interface ICreator
         * @property {number|null} [id] Creator id
         * @property {string|null} [name] Creator name
         * @property {string|null} [description] Creator description
         * @property {Array.<models.IModel>|null} [models] Creator models
         * @property {Array.<models.IModelPart>|null} [modelParts] Creator modelParts
         * @property {Array.<models.ICreatorLink>|null} [links] Creator links
         */
         ...
         * @implements ICreator
         * @constructor
         * @param {models.ICreator=} [properties] Properties to set
         */
         ...
         * Creator id.
         * @member {number} id
         * @memberof models.Creator
         * @instance
         */
        Creator.prototype.id = 0;
         ...
         * @instance
         */
        Creator.prototype.description = null;
         ...
         * @instance
         */
        Creator.prototype.models = $util.emptyArray;
         ...
         * @instance
         */
        Creator.prototype.modelParts = $util.emptyArray;

        /**
         * Creator links.
         * @member {Array.<models.ICreatorLink>} links
         * @memberof models.Creator
         * @instance
         */
        Creator.prototype.links = $util.emptyArray;

        // OneOf field names bound to virtual getters and setters
        let $oneOfFields;

        /**
         * Creator _description.
         * @member {"description"|undefined} _description
         * @memberof models.Creator
         * @instance
         */
        Object.defineProperty(Creator.prototype, "_description", {
            get: $util.oneOfGetter($oneOfFields = ["description"]),
            set: $util.oneOfSetter($oneOfFields)
        });

        /**
         * Creates a new Creator instance using the specified properties.
         * @function create
         * @memberof models.Creator
         * @static
         * @param {models.ICreator=} [properties] Properties to set
         * @returns {models.Creator} Creator instance
         */
        Creator.create = function create(properties) {
            return new Creator(properties);
        };

        /**
         * Encodes the specified Creator message. Does not implicitly {@link models.Creator.verify|verify} messages.
         * @function encode
         * @memberof models.Creator
         * @static
         * @param {models.ICreator} message Creator message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Creator.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.id != null && Object.hasOwnProperty.call(message, "id"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.id);
            ...
            if (message.modelParts != null && message.modelParts.length)
                for (let i = 0; i < message.modelParts.length; ++i)
                    $root.models.ModelPart.encode(message.modelParts[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            if (message.links != null && message.links.length)
                for (let i = 0; i < message.links.length; ++i)
                    $root.models.CreatorLink.encode(message.links[i], writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified Creator message, length delimited. Does not implicitly {@link models.Creator.verify|verify} messages.
         * @function encodeDelimited
         * @memberof models.Creator
         * @static
         * @param {models.ICreator} message Creator message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        Creator.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {models.Creator} Creator
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Creator.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.models.Creator();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
                ...
                case 6: {
                        if (!(message.links && message.links.length))
                            message.links = [];
                        message.links.push($root.models.CreatorLink.decode(reader, reader.uint32()));
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        /**
         * Decodes a Creator message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof models.Creator
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Creator.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        Creator.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            let properties = {};
            if (message.id != null && message.hasOwnProperty("id"))
            ...
            if (message.links != null && message.hasOwnProperty("links")) {
                ...
                for (let i = 0; i < message.links.length; ++i) {
                    let error = $root.models.CreatorLink.verify(message.links[i]);
                    if (error)
                        return "links." + error;
                }
            }
        ...
        /**
         * Creates a Creator message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof models.Creator
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {models.Creator} Creator
         */
        Creator.fromObject = function fromObject(object) {
            if (object instanceof $root.models.Creator)
                return object;
            let message = new $root.models.Creator();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.name != null)
                message.name = String(object.name);
            ...
            if (object.models) {
                if (!Array.isArray(object.models))
                    throw TypeError(".models.Creator.models: array expected");
                message.models = [];
                for (let i = 0; i < object.models.length; ++i) {
                    if (typeof object.models[i] !== "object")
                        throw TypeError(".models.Creator.models: object expected");
                    message.models[i] = $root.models.Model.fromObject(object.models[i]);
                }
            }
            if (object.modelParts) {
                if (!Array.isArray(object.modelParts))
                    throw TypeError(".models.Creator.modelParts: array expected");
                message.modelParts = [];
                for (let i = 0; i < object.modelParts.length; ++i) {
                    if (typeof object.modelParts[i] !== "object")
                        throw TypeError(".models.Creator.modelParts: object expected");
                    message.modelParts[i] = $root.models.ModelPart.fromObject(object.modelParts[i]);
                }
            }
            if (object.links) {
                if (!Array.isArray(object.links))
                    throw TypeError(".models.Creator.links: array expected");
                message.links = [];
                for (let i = 0; i < object.links.length; ++i) {
                    if (typeof object.links[i] !== "object")
                        throw TypeError(".models.Creator.links: object expected");
                    message.links[i] = $root.models.CreatorLink.fromObject(object.links[i]);
                }
            }
            return message;
        };
        ...
        /**
         * Creates a plain object from a Creator message. Also converts values to other types if specified.
         * @function toObject
         * @memberof models.Creator
         * @static
         * @param {models.Creator} message Creator
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Creator.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.arrays || options.defaults) {
            ...
            if (message.links && message.links.length) {
                ...
                for (let j = 0; j < message.links.length; ++j)
                    object.links[j] = $root.models.CreatorLink.toObject(message.links[j], options);
            }
            return object;
        };
         ...
         * @returns {Object.<string,*>} JSON object
         */
        Creator.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for Creator
         * @function getTypeUrl
         * @memberof models.Creator
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        Creator.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/models.Creator";
        };

        return Creator;
    })();

    models.CreatorLink = (function() {

        /**
         * Properties of a CreatorLink.
         * @memberof models
         * @interface ICreatorLink
         * @property {number|null} [id] CreatorLink id
         * @property {string|null} [name] CreatorLink name
         * @property {string|null} [link] CreatorLink link
         * @property {models.ICreator|null} [creator] CreatorLink creator
         * @property {models.CreatorLinkType|null} [type] CreatorLink type
         */

        /**
         * Constructs a new CreatorLink.
         * @memberof models
         * @classdesc Represents a CreatorLink.
         * @implements ICreatorLink
         * @constructor
         * @param {models.ICreatorLink=} [properties] Properties to set
         */
        function CreatorLink(properties) {
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * CreatorLink id.
         * @member {number} id
         * @memberof models.CreatorLink
         * @instance
         */
        CreatorLink.prototype.id = 0;
         ...
         * @instance
         */
        CreatorLink.prototype.link = "";

        /**
         * CreatorLink creator.
         * @member {models.ICreator|null|undefined} creator
         * @memberof models.CreatorLink
         * @instance
         */
        CreatorLink.prototype.creator = null;

        /**
         * CreatorLink type.
         * @member {models.CreatorLinkType} type
         * @memberof models.CreatorLink
         * @instance
         */
        CreatorLink.prototype.type = 0;

        /**
         * Creates a new CreatorLink instance using the specified properties.
         * @function create
         * @memberof models.CreatorLink
         * @static
         * @param {models.ICreatorLink=} [properties] Properties to set
         * @returns {models.CreatorLink} CreatorLink instance
         */
        CreatorLink.create = function create(properties) {
            return new CreatorLink(properties);
        };

        /**
         * Encodes the specified CreatorLink message. Does not implicitly {@link models.CreatorLink.verify|verify} messages.
         * @function encode
         * @memberof models.CreatorLink
         * @static
         * @param {models.ICreatorLink} message CreatorLink message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CreatorLink.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.id != null && Object.hasOwnProperty.call(message, "id"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.id);
            ...
            if (message.creator != null && Object.hasOwnProperty.call(message, "creator"))
                $root.models.Creator.encode(message.creator, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
        ...
        /**
         * Encodes the specified CreatorLink message, length delimited. Does not implicitly {@link models.CreatorLink.verify|verify} messages.
         * @function encodeDelimited
         * @memberof models.CreatorLink
         * @static
         * @param {models.ICreatorLink} message CreatorLink message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CreatorLink.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a CreatorLink message from the specified reader or buffer.
         * @function decode
         * @memberof models.CreatorLink
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {models.CreatorLink} CreatorLink
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CreatorLink.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.models.CreatorLink();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
                ...
                case 4: {
                        message.creator = $root.models.Creator.decode(reader, reader.uint32());
                        break;
                    }
                case 5: {
        ...
        /**
         * Decodes a CreatorLink message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof models.CreatorLink
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CreatorLink.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CreatorLink message.
         * @function verify
         * @memberof models.CreatorLink
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        CreatorLink.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.id != null && message.hasOwnProperty("id"))
                if (!$util.isInteger(message.id))
            ...
            if (message.creator != null && message.hasOwnProperty("creator")) {
                let error = $root.models.Creator.verify(message.creator);
                if (error)
        ...
        /**
         * Creates a CreatorLink message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof models.CreatorLink
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {models.CreatorLink} CreatorLink
         */
        CreatorLink.fromObject = function fromObject(object) {
            if (object instanceof $root.models.CreatorLink)
                return object;
            let message = new $root.models.CreatorLink();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.name != null)
                message.name = String(object.name);
            ...
            if (object.creator != null) {
                if (typeof object.creator !== "object")
                    throw TypeError(".models.CreatorLink.creator: object expected");
                message.creator = $root.models.Creator.fromObject(object.creator);
            }
            switch (object.type) {
            default:
        ...
        /**
         * Creates a plain object from a CreatorLink message. Also converts values to other types if specified.
         * @function toObject
         * @memberof models.CreatorLink
         * @static
         * @param {models.CreatorLink} message CreatorLink
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CreatorLink.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.defaults) {
            ...
            if (message.creator != null && message.hasOwnProperty("creator"))
                object.creator = $root.models.Creator.toObject(message.creator, options);
            if (message.type != null && message.hasOwnProperty("type"))
                object.type = options.enums === String ? $root.models.CreatorLinkType[message.type] === undefined ? message.type : $root.models.CreatorLinkType[message.type] : message.type;
            return object;
        };

        /**
         * Converts this CreatorLink to JSON.
         * @function toJSON
         * @memberof models.CreatorLink
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CreatorLink.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for CreatorLink
         * @function getTypeUrl
         * @memberof models.CreatorLink
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        CreatorLink.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/models.CreatorLink";
        };
    ...
    /**
     * CreatorLinkType enum.
     * @name models.CreatorLinkType
     * @enum {number}
     * @property {number} OTHER=0 OTHER value
     * @property {number} WEBSITE=1 WEBSITE value
     * @property {number} PATREON=2 PATREON value
     * @property {number} YOUTUBE=3 YOUTUBE value
     * @property {number} FACEBOOK=4 FACEBOOK value
     * @property {number} INSTAGRAM=5 INSTAGRAM value
     * @property {number} X=6 X value
     * @property {number} DISCORD=7 DISCORD value
     * @property {number} THINGIVERSE=8 THINGIVERSE value
     * @property {number} CGTRADER=9 CGTRADER value
     * @property {number} PRINTED_WARGAMES=10 PRINTED_WARGAMES value
     * @property {number} ETSY=11 ETSY value
     * @property {number} CULTS3D=12 CULTS3D value
     * @property {number} MYMINIFACTORY=13 MYMINIFACTORY value
     * @property {number} KICKSTARTER=14 KICKSTARTER value
     * @property {number} PRINTABLES=15 PRINTABLES value
     */
    models.CreatorLinkType = (function() {
        const valuesById = {}, values = Object.create(valuesById);
        values[valuesById[0] = "OTHER"] = 0;
        values[valuesById[1] = "WEBSITE"] = 1;
        values[valuesById[2] = "PATREON"] = 2;
        values[valuesById[3] = "YOUTUBE"] = 3;
        values[valuesById[4] = "FACEBOOK"] = 4;
        values[valuesById[5] = "INSTAGRAM"] = 5;
        values[valuesById[6] = "X"] = 6;
        values[valuesById[7] = "DISCORD"] = 7;
        values[valuesById[8] = "THINGIVERSE"] = 8;
        values[valuesById[9] = "CGTRADER"] = 9;
        values[valuesById[10] = "PRINTED_WARGAMES"] = 10;
        values[valuesById[11] = "ETSY"] = 11;
        values[valuesById[12] = "CULTS3D"] = 12;
        values[valuesById[13] = "MYMINIFACTORY"] = 13;
        values[valuesById[14] = "KICKSTARTER"] = 14;
        values[valuesById[15] = "PRINTABLES"] = 15;
        return values;
    })();
    ...
    models.Storage = (function() {
         ...
         * @property {models.StorageReferenceProtocol|null} [protocol] Storage protocol
         * @property {models.IStorageCredentials|null} [credentials] Storage credentials
         * @property {models.IStorageLocation|null} [location] Storage location
         */
         ...
         * @implements IStorage
         * @constructor
         * @param {models.IStorage=} [properties] Properties to set
         */
        function Storage(properties) {
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
        ...
        /**
         * Storage protocol.
         * @member {models.StorageReferenceProtocol} protocol
         * @memberof models.Storage
         * @instance
         */
        Storage.prototype.protocol = 0;

        /**
         * Storage credentials.
         * @member {models.IStorageCredentials|null|undefined} credentials
         * @memberof models.Storage
         * @instance
         */
        Storage.prototype.credentials = null;

        /**
         * Storage location.
         * @member {models.IStorageLocation|null|undefined} location
         * @memberof models.Storage
         * @instance
         */
        Storage.prototype.location = null;
         ...
         * @static
         * @param {models.IStorage=} [properties] Properties to set
         * @returns {models.Storage} Storage instance
         */
        Storage.create = function create(properties) {
            return new Storage(properties);
        };
        ...
        /**
         * Encodes the specified Storage message. Does not implicitly {@link models.Storage.verify|verify} messages.
         * @function encode
         * @memberof models.Storage
         * @static
         * @param {models.IStorage} message Storage message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Storage.encode = function encode(message, writer) {
            ...
            if (message.credentials != null && Object.hasOwnProperty.call(message, "credentials"))
                $root.models.StorageCredentials.encode(message.credentials, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            if (message.location != null && Object.hasOwnProperty.call(message, "location"))
                $root.models.StorageLocation.encode(message.location, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified Storage message, length delimited. Does not implicitly {@link models.Storage.verify|verify} messages.
         * @function encodeDelimited
         * @memberof models.Storage
         * @static
         * @param {models.IStorage} message Storage message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {models.Storage} Storage
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Storage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.models.Storage();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
                ...
                case 5: {
                        message.credentials = $root.models.StorageCredentials.decode(reader, reader.uint32());
                        break;
                    }
                case 6: {
                        message.location = $root.models.StorageLocation.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        Storage.verify = function verify(message) {
            ...
            if (message.credentials != null && message.hasOwnProperty("credentials")) {
                let error = $root.models.StorageCredentials.verify(message.credentials);
                if (error)
                    return "credentials." + error;
            }
            if (message.location != null && message.hasOwnProperty("location")) {
                let error = $root.models.StorageLocation.verify(message.location);
                if (error)
         ...
         */
        Storage.fromObject = function fromObject(object) {
            if (object instanceof $root.models.Storage)
                return object;
            let message = new $root.models.Storage();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.name != null)
                message.name = String(object.name);
            ...
            if (object.credentials != null) {
                if (typeof object.credentials !== "object")
                    throw TypeError(".models.Storage.credentials: object expected");
                message.credentials = $root.models.StorageCredentials.fromObject(object.credentials);
            }
            if (object.location != null) {
                if (typeof object.location !== "object")
                    throw TypeError(".models.Storage.location: object expected");
                message.location = $root.models.StorageLocation.fromObject(object.location);
            }
            return message;
        };
         ...
         * @memberof models.Storage
         * @static
         * @param {models.Storage} message Storage
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Storage.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                object.id = 0;
                object.name = "";
                object.protocol = options.enums === String ? "LOCALE" : 0;
            ...
            if (message.protocol != null && message.hasOwnProperty("protocol"))
                object.protocol = options.enums === String ? $root.models.StorageReferenceProtocol[message.protocol] === undefined ? message.protocol : $root.models.StorageReferenceProtocol[message.protocol] : message.protocol;
            if (message.credentials != null && message.hasOwnProperty("credentials"))
                object.credentials = $root.models.StorageCredentials.toObject(message.credentials, options);
            if (message.location != null && message.hasOwnProperty("location"))
                object.location = $root.models.StorageLocation.toObject(message.location, options);
            return object;
        };
        ...
        Storage.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/models.Storage";
        };
    ...
    /**
     * StorageReferenceProtocol enum.
     * @name models.StorageReferenceProtocol
     * @enum {number}
     * @property {number} LOCALE=0 LOCALE value
     * @property {number} SMB=1 SMB value
     * @property {number} NFS=2 NFS value
     * @property {number} NFS_4=3 NFS_4 value
     * @property {number} FTP=4 FTP value
     */
    models.StorageReferenceProtocol = (function() {
        const valuesById = {}, values = Object.create(valuesById);
        values[valuesById[0] = "LOCALE"] = 0;
        values[valuesById[1] = "SMB"] = 1;
        values[valuesById[2] = "NFS"] = 2;
        values[valuesById[3] = "NFS_4"] = 3;
        values[valuesById[4] = "FTP"] = 4;
        return values;
    })();

    models.StorageLocation = (function() {

        /**
         * Properties of a StorageLocation.
         * @memberof models
         * @interface IStorageLocation
         * @property {gorm.types.IInetValue|null} [ip] StorageLocation ip
         * @property {string|null} [hostname] StorageLocation hostname
         * @property {string|null} [path] StorageLocation path
         */

        /**
         * Constructs a new StorageLocation.
         * @memberof models
         * @classdesc Represents a StorageLocation.
         * @implements IStorageLocation
         * @constructor
         * @param {models.IStorageLocation=} [properties] Properties to set
         */
        function StorageLocation(properties) {
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * StorageLocation ip.
         * @member {gorm.types.IInetValue|null|undefined} ip
         * @memberof models.StorageLocation
         * @instance
         */
        StorageLocation.prototype.ip = null;

        /**
         * StorageLocation hostname.
         * @member {string|null|undefined} hostname
         * @memberof models.StorageLocation
         * @instance
         */
        StorageLocation.prototype.hostname = null;
         ...
         * @instance
         */
        StorageLocation.prototype.path = null;
         ...
         * @instance
         */
        Object.defineProperty(StorageLocation.prototype, "_ip", {
            get: $util.oneOfGetter($oneOfFields = ["ip"]),
            set: $util.oneOfSetter($oneOfFields)
        });

        /**
         * StorageLocation _hostname.
         * @member {"hostname"|undefined} _hostname
         * @memberof models.StorageLocation
         * @instance
         */
        Object.defineProperty(StorageLocation.prototype, "_hostname", {
            get: $util.oneOfGetter($oneOfFields = ["hostname"]),
            set: $util.oneOfSetter($oneOfFields)
        });

        /**
         * StorageLocation _path.
         * @member {"path"|undefined} _path
         * @memberof models.StorageLocation
         * @instance
         */
        Object.defineProperty(StorageLocation.prototype, "_path", {
            get: $util.oneOfGetter($oneOfFields = ["path"]),
            set: $util.oneOfSetter($oneOfFields)
        });

        /**
         * Creates a new StorageLocation instance using the specified properties.
         * @function create
         * @memberof models.StorageLocation
         * @static
         * @param {models.IStorageLocation=} [properties] Properties to set
         * @returns {models.StorageLocation} StorageLocation instance
         */
        StorageLocation.create = function create(properties) {
            return new StorageLocation(properties);
        };

        /**
         * Encodes the specified StorageLocation message. Does not implicitly {@link models.StorageLocation.verify|verify} messages.
         * @function encode
         * @memberof models.StorageLocation
         * @static
         * @param {models.IStorageLocation} message StorageLocation message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        StorageLocation.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.ip != null && Object.hasOwnProperty.call(message, "ip"))
                $root.gorm.types.InetValue.encode(message.ip, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
        ...
        /**
         * Encodes the specified StorageLocation message, length delimited. Does not implicitly {@link models.StorageLocation.verify|verify} messages.
         * @function encodeDelimited
         * @memberof models.StorageLocation
         * @static
         * @param {models.IStorageLocation} message StorageLocation message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        StorageLocation.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a StorageLocation message from the specified reader or buffer.
         * @function decode
         * @memberof models.StorageLocation
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {models.StorageLocation} StorageLocation
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        StorageLocation.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.models.StorageLocation();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 2: {
                        message.ip = $root.gorm.types.InetValue.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
        ...
        /**
         * Decodes a StorageLocation message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof models.StorageLocation
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        StorageLocation.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a StorageLocation message.
         * @function verify
         * @memberof models.StorageLocation
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        StorageLocation.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            let properties = {};
            if (message.ip != null && message.hasOwnProperty("ip")) {
                properties._ip = 1;
                {
                    let error = $root.gorm.types.InetValue.verify(message.ip);
                    if (error)
                        return "ip." + error;
                }
            }
        ...
        /**
         * Creates a StorageLocation message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof models.StorageLocation
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {models.StorageLocation} StorageLocation
         */
        StorageLocation.fromObject = function fromObject(object) {
            if (object instanceof $root.models.StorageLocation)
                return object;
            let message = new $root.models.StorageLocation();
            if (object.ip != null) {
                if (typeof object.ip !== "object")
                    throw TypeError(".models.StorageLocation.ip: object expected");
                message.ip = $root.gorm.types.InetValue.fromObject(object.ip);
            }
        ...
        /**
         * Creates a plain object from a StorageLocation message. Also converts values to other types if specified.
         * @function toObject
         * @memberof models.StorageLocation
         * @static
         * @param {models.StorageLocation} message StorageLocation
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        StorageLocation.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (message.ip != null && message.hasOwnProperty("ip")) {
                object.ip = $root.gorm.types.InetValue.toObject(message.ip, options);
                if (options.oneofs)
                    object._ip = "ip";
            }
            if (message.hostname != null && message.hasOwnProperty("hostname")) {
        ...
        /**
         * Converts this StorageLocation to JSON.
         * @function toJSON
         * @memberof models.StorageLocation
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        StorageLocation.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for StorageLocation
         * @function getTypeUrl
         * @memberof models.StorageLocation
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        StorageLocation.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/models.StorageLocation";
        };

        return StorageLocation;
    })();

    models.StorageCredentials = (function() {

        /**
         * Properties of a StorageCredentials.
         * @memberof models
         * @interface IStorageCredentials
         * @property {number|null} [id] StorageCredentials id
         * @property {string|null} [user] StorageCredentials user
         * @property {string|null} [password] StorageCredentials password
         */

        /**
         * Constructs a new StorageCredentials.
         * @memberof models
         * @classdesc Represents a StorageCredentials.
         * @implements IStorageCredentials
         * @constructor
         * @param {models.IStorageCredentials=} [properties] Properties to set
         */
        function StorageCredentials(properties) {
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * StorageCredentials id.
         * @member {number} id
         * @memberof models.StorageCredentials
         * @instance
         */
        StorageCredentials.prototype.id = 0;

        /**
         * StorageCredentials user.
         * @member {string} user
         * @memberof models.StorageCredentials
         * @instance
         */
        StorageCredentials.prototype.user = "";

        /**
         * StorageCredentials password.
         * @member {string|null|undefined} password
         * @memberof models.StorageCredentials
         * @instance
         */
        StorageCredentials.prototype.password = null;

        // OneOf field names bound to virtual getters and setters
        let $oneOfFields;

        /**
         * StorageCredentials _password.
         * @member {"password"|undefined} _password
         * @memberof models.StorageCredentials
         * @instance
         */
        Object.defineProperty(StorageCredentials.prototype, "_password", {
            get: $util.oneOfGetter($oneOfFields = ["password"]),
            set: $util.oneOfSetter($oneOfFields)
        });

        /**
         * Creates a new StorageCredentials instance using the specified properties.
         * @function create
         * @memberof models.StorageCredentials
         * @static
         * @param {models.IStorageCredentials=} [properties] Properties to set
         * @returns {models.StorageCredentials} StorageCredentials instance
         */
        StorageCredentials.create = function create(properties) {
            return new StorageCredentials(properties);
        };

        /**
         * Encodes the specified StorageCredentials message. Does not implicitly {@link models.StorageCredentials.verify|verify} messages.
         * @function encode
         * @memberof models.StorageCredentials
         * @static
         * @param {models.IStorageCredentials} message StorageCredentials message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        StorageCredentials.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.id != null && Object.hasOwnProperty.call(message, "id"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.id);
        ...
        /**
         * Encodes the specified StorageCredentials message, length delimited. Does not implicitly {@link models.StorageCredentials.verify|verify} messages.
         * @function encodeDelimited
         * @memberof models.StorageCredentials
         * @static
         * @param {models.IStorageCredentials} message StorageCredentials message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        StorageCredentials.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a StorageCredentials message from the specified reader or buffer.
         * @function decode
         * @memberof models.StorageCredentials
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {models.StorageCredentials} StorageCredentials
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        StorageCredentials.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.models.StorageCredentials();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        /**
         * Decodes a StorageCredentials message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof models.StorageCredentials
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        StorageCredentials.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a StorageCredentials message.
         * @function verify
         * @memberof models.StorageCredentials
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        StorageCredentials.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            let properties = {};
            if (message.id != null && message.hasOwnProperty("id"))
        ...
        /**
         * Creates a StorageCredentials message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof models.StorageCredentials
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {models.StorageCredentials} StorageCredentials
         */
        StorageCredentials.fromObject = function fromObject(object) {
            if (object instanceof $root.models.StorageCredentials)
                return object;
            let message = new $root.models.StorageCredentials();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.user != null)
        ...
        /**
         * Creates a plain object from a StorageCredentials message. Also converts values to other types if specified.
         * @function toObject
         * @memberof models.StorageCredentials
         * @static
         * @param {models.StorageCredentials} message StorageCredentials
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        StorageCredentials.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this StorageCredentials to JSON.
         * @function toJSON
         * @memberof models.StorageCredentials
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        StorageCredentials.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for StorageCredentials
         * @function getTypeUrl
         * @memberof models.StorageCredentials
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        StorageCredentials.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/models.StorageCredentials";
        };
...
export const gorm = $root.gorm = (() => {
    ...
    gorm.types = (function() {
        ...
        types.UUIDValue = (function() {

            /**
             * Properties of a UUIDValue.
             * @memberof gorm.types
             * @interface IUUIDValue
             * @property {string|null} [value] UUIDValue value
             */

            /**
             * Constructs a new UUIDValue.
             * @memberof gorm.types
             * @classdesc Represents a UUIDValue.
             * @implements IUUIDValue
             * @constructor
             * @param {gorm.types.IUUIDValue=} [properties] Properties to set
             */
            function UUIDValue(properties) {
                if (properties)
                    for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
             ...
             * UUIDValue value.
             * @member {string} value
             * @memberof gorm.types.UUIDValue
             * @instance
             */
            UUIDValue.prototype.value = "";

            /**
             * Creates a new UUIDValue instance using the specified properties.
             * @function create
             * @memberof gorm.types.UUIDValue
             * @static
             * @param {gorm.types.IUUIDValue=} [properties] Properties to set
             * @returns {gorm.types.UUIDValue} UUIDValue instance
             */
            UUIDValue.create = function create(properties) {
                return new UUIDValue(properties);
            };

            /**
             * Encodes the specified UUIDValue message. Does not implicitly {@link gorm.types.UUIDValue.verify|verify} messages.
             * @function encode
             * @memberof gorm.types.UUIDValue
             * @static
             * @param {gorm.types.IUUIDValue} message UUIDValue message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            UUIDValue.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
            ...
            /**
             * Encodes the specified UUIDValue message, length delimited. Does not implicitly {@link gorm.types.UUIDValue.verify|verify} messages.
             * @function encodeDelimited
             * @memberof gorm.types.UUIDValue
             * @static
             * @param {gorm.types.IUUIDValue} message UUIDValue message or plain object to encode
             ...
             * @returns {$protobuf.Writer} Writer
             */
            UUIDValue.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };

            /**
             * Decodes a UUIDValue message from the specified reader or buffer.
             * @function decode
             * @memberof gorm.types.UUIDValue
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {gorm.types.UUIDValue} UUIDValue
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            UUIDValue.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.gorm.types.UUIDValue();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            /**
             * Decodes a UUIDValue message from the specified reader or buffer, length delimited.
             * @function decodeDelimited
             * @memberof gorm.types.UUIDValue
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            UUIDValue.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
             ...
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            UUIDValue.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
            ...
            /**
             * Creates a UUIDValue message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof gorm.types.UUIDValue
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {gorm.types.UUIDValue} UUIDValue
             */
            UUIDValue.fromObject = function fromObject(object) {
                if (object instanceof $root.gorm.types.UUIDValue)
                    return object;
                let message = new $root.gorm.types.UUIDValue();
            ...
            /**
             * Creates a plain object from a UUIDValue message. Also converts values to other types if specified.
             * @function toObject
             * @memberof gorm.types.UUIDValue
             * @static
             * @param {gorm.types.UUIDValue} message UUIDValue
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            UUIDValue.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                let object = {};
                if (options.defaults)
            ...
            /**
             * Converts this UUIDValue to JSON.
             * @function toJSON
             * @memberof gorm.types.UUIDValue
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            UUIDValue.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };

            /**
             * Gets the default type url for UUIDValue
             * @function getTypeUrl
             * @memberof gorm.types.UUIDValue
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            UUIDValue.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/gorm.types.UUIDValue";
            };

            return UUIDValue;
        })();

        types.JSONValue = (function() {

            /**
             * Properties of a JSONValue.
             * @memberof gorm.types
             * @interface IJSONValue
             * @property {string|null} [value] JSONValue value
             */

            /**
             * Constructs a new JSONValue.
             * @memberof gorm.types
             * @classdesc Represents a JSONValue.
             * @implements IJSONValue
             * @constructor
             * @param {gorm.types.IJSONValue=} [properties] Properties to set
             */
            function JSONValue(properties) {
                if (properties)
                    for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
             ...
             * JSONValue value.
             * @member {string} value
             * @memberof gorm.types.JSONValue
             * @instance
             */
            JSONValue.prototype.value = "";

            /**
             * Creates a new JSONValue instance using the specified properties.
             * @function create
             * @memberof gorm.types.JSONValue
             * @static
             * @param {gorm.types.IJSONValue=} [properties] Properties to set
             * @returns {gorm.types.JSONValue} JSONValue instance
             */
            JSONValue.create = function create(properties) {
                return new JSONValue(properties);
            };

            /**
             * Encodes the specified JSONValue message. Does not implicitly {@link gorm.types.JSONValue.verify|verify} messages.
             * @function encode
             * @memberof gorm.types.JSONValue
             * @static
             * @param {gorm.types.IJSONValue} message JSONValue message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            JSONValue.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.value != null && Object.hasOwnProperty.call(message, "value"))
                    writer.uint32(/* id 1, wireType 2 =*/10).string(message.value);
            ...
            /**
             * Encodes the specified JSONValue message, length delimited. Does not implicitly {@link gorm.types.JSONValue.verify|verify} messages.
             * @function encodeDelimited
             * @memberof gorm.types.JSONValue
             * @static
             * @param {gorm.types.IJSONValue} message JSONValue message or plain object to encode
             ...
             * @returns {$protobuf.Writer} Writer
             */
            JSONValue.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };

            /**
             * Decodes a JSONValue message from the specified reader or buffer.
             * @function decode
             * @memberof gorm.types.JSONValue
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {gorm.types.JSONValue} JSONValue
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            JSONValue.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.gorm.types.JSONValue();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            /**
             * Decodes a JSONValue message from the specified reader or buffer, length delimited.
             * @function decodeDelimited
             * @memberof gorm.types.JSONValue
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            JSONValue.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
             ...
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            JSONValue.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.value != null && message.hasOwnProperty("value"))
                    if (!$util.isString(message.value))
            ...
            /**
             * Creates a JSONValue message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof gorm.types.JSONValue
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {gorm.types.JSONValue} JSONValue
             */
            JSONValue.fromObject = function fromObject(object) {
                if (object instanceof $root.gorm.types.JSONValue)
                    return object;
                let message = new $root.gorm.types.JSONValue();
                if (object.value != null)
                    message.value = String(object.value);
                return message;
            };
            ...
            /**
             * Creates a plain object from a JSONValue message. Also converts values to other types if specified.
             * @function toObject
             * @memberof gorm.types.JSONValue
             * @static
             * @param {gorm.types.JSONValue} message JSONValue
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            JSONValue.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                let object = {};
                if (options.defaults)
            ...
            /**
             * Converts this JSONValue to JSON.
             * @function toJSON
             * @memberof gorm.types.JSONValue
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            JSONValue.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };

            /**
             * Gets the default type url for JSONValue
             * @function getTypeUrl
             * @memberof gorm.types.JSONValue
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            JSONValue.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/gorm.types.JSONValue";
            };
        ...
        types.UUID = (function() {
             ...
             * @implements IUUID
             * @constructor
             * @param {gorm.types.IUUID=} [properties] Properties to set
             */
             ...
             * @static
             * @param {gorm.types.IUUID=} [properties] Properties to set
             * @returns {gorm.types.UUID} UUID instance
             */
            ...
            /**
             * Encodes the specified UUID message. Does not implicitly {@link gorm.types.UUID.verify|verify} messages.
             * @function encode
             * @memberof gorm.types.UUID
             * @static
             * @param {gorm.types.IUUID} message UUID message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ...
            /**
             * Encodes the specified UUID message, length delimited. Does not implicitly {@link gorm.types.UUID.verify|verify} messages.
             * @function encodeDelimited
             * @memberof gorm.types.UUID
             * @static
             * @param {gorm.types.IUUID} message UUID message or plain object to encode
            ...
            UUID.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.gorm.types.UUID();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            UUID.fromObject = function fromObject(object) {
                if (object instanceof $root.gorm.types.UUID)
                    return object;
                let message = new $root.gorm.types.UUID();
                if (object.value != null)
                    message.value = String(object.value);
                return message;
            };
             ...
             * @memberof gorm.types.UUID
             * @static
             * @param {gorm.types.UUID} message UUID
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            ...
            UUID.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/gorm.types.UUID";
            };

            return UUID;
        })();

        types.InetValue = (function() {

            /**
             * Properties of an InetValue.
             * @memberof gorm.types
             * @interface IInetValue
             * @property {string|null} [value] InetValue value
             */

            /**
             * Constructs a new InetValue.
             * @memberof gorm.types
             * @classdesc Represents an InetValue.
             * @implements IInetValue
             * @constructor
             * @param {gorm.types.IInetValue=} [properties] Properties to set
             */
            function InetValue(properties) {
                if (properties)
                    for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
             ...
             * InetValue value.
             * @member {string} value
             * @memberof gorm.types.InetValue
             * @instance
             */
            InetValue.prototype.value = "";

            /**
             * Creates a new InetValue instance using the specified properties.
             * @function create
             * @memberof gorm.types.InetValue
             * @static
             * @param {gorm.types.IInetValue=} [properties] Properties to set
             * @returns {gorm.types.InetValue} InetValue instance
             */
            InetValue.create = function create(properties) {
                return new InetValue(properties);
            };

            /**
             * Encodes the specified InetValue message. Does not implicitly {@link gorm.types.InetValue.verify|verify} messages.
             * @function encode
             * @memberof gorm.types.InetValue
             * @static
             * @param {gorm.types.IInetValue} message InetValue message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            InetValue.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.value != null && Object.hasOwnProperty.call(message, "value"))
                    writer.uint32(/* id 1, wireType 2 =*/10).string(message.value);
            ...
            /**
             * Encodes the specified InetValue message, length delimited. Does not implicitly {@link gorm.types.InetValue.verify|verify} messages.
             * @function encodeDelimited
             * @memberof gorm.types.InetValue
             * @static
             * @param {gorm.types.IInetValue} message InetValue message or plain object to encode
             ...
             * @returns {$protobuf.Writer} Writer
             */
            InetValue.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };

            /**
             * Decodes an InetValue message from the specified reader or buffer.
             * @function decode
             * @memberof gorm.types.InetValue
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {gorm.types.InetValue} InetValue
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            InetValue.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.gorm.types.InetValue();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            /**
             * Decodes an InetValue message from the specified reader or buffer, length delimited.
             * @function decodeDelimited
             * @memberof gorm.types.InetValue
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            InetValue.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
             ...
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            InetValue.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.value != null && message.hasOwnProperty("value"))
                    if (!$util.isString(message.value))
            ...
            /**
             * Creates an InetValue message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof gorm.types.InetValue
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {gorm.types.InetValue} InetValue
             */
            InetValue.fromObject = function fromObject(object) {
                if (object instanceof $root.gorm.types.InetValue)
                    return object;
                let message = new $root.gorm.types.InetValue();
                if (object.value != null)
                    message.value = String(object.value);
                return message;
            };
            ...
            /**
             * Creates a plain object from an InetValue message. Also converts values to other types if specified.
             * @function toObject
             * @memberof gorm.types.InetValue
             * @static
             * @param {gorm.types.InetValue} message InetValue
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            InetValue.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                let object = {};
                if (options.defaults)
            ...
            /**
             * Converts this InetValue to JSON.
             * @function toJSON
             * @memberof gorm.types.InetValue
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            InetValue.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };

            /**
             * Gets the default type url for InetValue
             * @function getTypeUrl
             * @memberof gorm.types.InetValue
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            InetValue.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/gorm.types.InetValue";
            };

            return InetValue;
        })();

        types.TimeOnly = (function() {

            /**
             * Properties of a TimeOnly.
             * @memberof gorm.types
             * @interface ITimeOnly
             * @property {number|null} [value] TimeOnly value
             */

            /**
             * Constructs a new TimeOnly.
             * @memberof gorm.types
             * @classdesc Represents a TimeOnly.
             * @implements ITimeOnly
             * @constructor
             * @param {gorm.types.ITimeOnly=} [properties] Properties to set
             */
            function TimeOnly(properties) {
                if (properties)
                    for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
             ...
             * TimeOnly value.
             * @member {number} value
             * @memberof gorm.types.TimeOnly
             * @instance
             */
            TimeOnly.prototype.value = 0;

            /**
             * Creates a new TimeOnly instance using the specified properties.
             * @function create
             * @memberof gorm.types.TimeOnly
             * @static
             * @param {gorm.types.ITimeOnly=} [properties] Properties to set
             * @returns {gorm.types.TimeOnly} TimeOnly instance
             */
            TimeOnly.create = function create(properties) {
                return new TimeOnly(properties);
            };

            /**
             * Encodes the specified TimeOnly message. Does not implicitly {@link gorm.types.TimeOnly.verify|verify} messages.
             * @function encode
             * @memberof gorm.types.TimeOnly
             * @static
             * @param {gorm.types.ITimeOnly} message TimeOnly message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            TimeOnly.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.value != null && Object.hasOwnProperty.call(message, "value"))
            ...
            /**
             * Encodes the specified TimeOnly message, length delimited. Does not implicitly {@link gorm.types.TimeOnly.verify|verify} messages.
             * @function encodeDelimited
             * @memberof gorm.types.TimeOnly
             * @static
             * @param {gorm.types.ITimeOnly} message TimeOnly message or plain object to encode
             ...
             * @returns {$protobuf.Writer} Writer
             */
            TimeOnly.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };

            /**
             * Decodes a TimeOnly message from the specified reader or buffer.
             * @function decode
             * @memberof gorm.types.TimeOnly
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {gorm.types.TimeOnly} TimeOnly
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            TimeOnly.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.gorm.types.TimeOnly();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            /**
             * Decodes a TimeOnly message from the specified reader or buffer, length delimited.
             * @function decodeDelimited
             * @memberof gorm.types.TimeOnly
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            TimeOnly.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
             ...
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            TimeOnly.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.value != null && message.hasOwnProperty("value"))
            ...
            /**
             * Creates a TimeOnly message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof gorm.types.TimeOnly
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {gorm.types.TimeOnly} TimeOnly
             */
            TimeOnly.fromObject = function fromObject(object) {
                if (object instanceof $root.gorm.types.TimeOnly)
                    return object;
                let message = new $root.gorm.types.TimeOnly();
                if (object.value != null)
            ...
            /**
             * Creates a plain object from a TimeOnly message. Also converts values to other types if specified.
             * @function toObject
             * @memberof gorm.types.TimeOnly
             * @static
             * @param {gorm.types.TimeOnly} message TimeOnly
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            TimeOnly.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                let object = {};
                if (options.defaults)
            ...
            /**
             * Converts this TimeOnly to JSON.
             * @function toJSON
             * @memberof gorm.types.TimeOnly
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            TimeOnly.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };

            /**
             * Gets the default type url for TimeOnly
             * @function getTypeUrl
             * @memberof gorm.types.TimeOnly
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            TimeOnly.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/gorm.types.TimeOnly";
            };

            return TimeOnly;
        })();

        types.BigInt = (function() {

            /**
             * Properties of a BigInt.
             * @memberof gorm.types
             * @interface IBigInt
             * @property {string|null} [value] BigInt value
             */
             ...
             * @implements IBigInt
             * @constructor
             * @param {gorm.types.IBigInt=} [properties] Properties to set
             */
             ...
             * BigInt value.
             * @member {string} value
             * @memberof gorm.types.BigInt
             * @instance
             */
            BigInt.prototype.value = "";
             ...
             * @static
             * @param {gorm.types.IBigInt=} [properties] Properties to set
             * @returns {gorm.types.BigInt} BigInt instance
             */
            ...
            /**
             * Encodes the specified BigInt message. Does not implicitly {@link gorm.types.BigInt.verify|verify} messages.
             * @function encode
             * @memberof gorm.types.BigInt
             * @static
             * @param {gorm.types.IBigInt} message BigInt message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ...
            /**
             * Encodes the specified BigInt message, length delimited. Does not implicitly {@link gorm.types.BigInt.verify|verify} messages.
             * @function encodeDelimited
             * @memberof gorm.types.BigInt
             * @static
             * @param {gorm.types.IBigInt} message BigInt message or plain object to encode
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {gorm.types.BigInt} BigInt
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            BigInt.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.gorm.types.BigInt();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            BigInt.fromObject = function fromObject(object) {
                if (object instanceof $root.gorm.types.BigInt)
                    return object;
                let message = new $root.gorm.types.BigInt();
                if (object.value != null)
                    message.value = String(object.value);
                return message;
            };
             ...
             * @memberof gorm.types.BigInt
             * @static
             * @param {gorm.types.BigInt} message BigInt
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            ...
            BigInt.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/gorm.types.BigInt";
            };
